 ...
 */
  ...
  */
  ...
  //TensorNetwork *network is the network to append to, and TensorNetwork append_network is the
  //network that will be appended to *network
  //PyBind cannot bind this function simply within the TensorNetwork class due to the && argument
  m.def("appendTensorNetwork", [](TensorNetwork *network, TensorNetwork append_network,
